...
<div style="margin-top: 100px;">
    <form class="signinbox" style="height: 450px;" method="post" action="authenticateadmin.php" onsubmit="return validateEmail()">
        <h2 class="headd">Login Admin</h2>
        ...
        <button type="submit" class="submitbtn" name="adminloginbtn">Login</button>
