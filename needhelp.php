            ...
            <p style = "text-align: justify;">At FashionFix, we value your feedback, questions, and concerns. Whether you need assistance with an order, 
                ...
                <div class="div1-div">
                   <!-- <div class = "div1-div1">
                    ...
                    <div class = "div1-div2">
                        <form action="complaintsInsert.php" method="post" onsubmit="return validation()">
                            Name: <br />
                            <input type="text" name="fullName" placeholder="First Name" id="fname" required><br /><br />
                            ...
                            Complaint: <br />
                            <textarea cols="50" rows="5" placeholder="Your complaint" id="complaint" name="complaint"></textarea><br /><br />
