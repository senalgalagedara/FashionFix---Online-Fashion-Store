...
<?php
    ...
    $sql = "INSERT INTO driver (driver_ID , fname , lname , Password , Age , adress , contNo , Email , acc_no , acc_name , bname)
	VALUES ('' , '$Fname', '$Lname', $password , $Age ,'$Adress' , '$Cno' , '$email' , '$accountNo' , '$accountName' , '$Bname')";
